...
import type { Contact as _Contact } from "./declarations/backend.did.d.ts";
...
function from_candid_record_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        submitter: record_opt_to_undefined(from_candid_opt_n4(_uploadFile, _downloadFile, value.submitter)),
        name: value.name,
        email: value.email,
